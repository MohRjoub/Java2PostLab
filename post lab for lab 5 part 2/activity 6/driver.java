...
public class driver {
	...
	public static void main(String[] args) {
		...
		students.add(new scientific(1, 123456789, "Ali", 'M', "School1"));
		students.add(new scientific(2, 987654321, "Ahmad", 'M', "School2"));
		students.add(new scientific(3, 345678901, "Noor", 'F', "School3"));
		students.add(new literary(4, 999129999, "Alawi", 'M', "School1"));
